...
export default class Form extends InputContainer {
    ...
    _renderChildren( children ) {
        ...
        if ( childrenCount > 1 ) {
            return Children.map( children, child => this._renderChild( child ) );
        ...
        if ( child.type === ValidatedInput ||
            ...
            if ( error ) {
                ...
                if ( typeof error === 'string' ) {
                    ...
                    console.log(typeof child.props.errorHelp)
                    newProps.help = createFragment( child.props.errorHelp );
                }
            }
            return cloneElement( child, newProps );
        } else {
            return cloneElement( child, {}, this._renderChildren( child.props && child.props.children ) );
        }
    }
