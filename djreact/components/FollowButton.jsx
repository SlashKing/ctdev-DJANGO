  ...
  return {
	follow: () => {
		...
		if(props.search === 'true'){
			dispatch(searchActions.updateIsFollowing(props.user.is_following,props.index))
		}else{ 
			dispatch(updateIsFollowing(props.user.is_following,props.index))
		}
		dispatch(followActions.follow(props.user.id,localStorage.user_id))
	}, 
	removeFollow:() => {
		if(props.search === 'true'){
			dispatch(searchActions.updateIsFollowing(props.user.is_following,props.index))
		...
		dispatch(followActions.removeFollow(props.user.id,localStorage.user_id))
	}
